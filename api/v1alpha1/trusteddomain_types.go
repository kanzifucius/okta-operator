...
type TrustedDomainStatus struct {
...
// TrustedDomain is the Schema for the trusteddomains API
type TrustedDomain struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`

	Spec   TrustedDomainSpec   `json:"spec,omitempty"`
	Status TrustedDomainStatus `json:"status,omitempty"`
}

//+kubebuilder:object:root=true

// TrustedDomainList contains a list of TrustedDomain
type TrustedDomainList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []TrustedDomain `json:"items"`
}

func init() {
	SchemeBuilder.Register(&TrustedDomain{}, &TrustedDomainList{})
}
